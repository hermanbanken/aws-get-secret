...
type Lambda = Pick<(lambda.Function | lambdaNodejs.NodejsFunction | lambdaPython.PythonFunction), "addLayers"|"addEnvironment"|"stack">;
...
export function wrapLambdaWithSecrets(lambda: Lambda, opts: Opts, layer: lambda.LayerVersion) {
